...
Bayesian hyperparameter tuning for simulating the maximum ice formation within the cathode CL during the cold start of PEMFCs.
...
if __name__ == "__main__":
    ...
    # 保存模型
    joblib.dump(best_model, 'icevolume_SVR_optimized.pkl')
    print(f"优化后的SVR模型已保存: icevolume_SVR_optimized.pkl")
