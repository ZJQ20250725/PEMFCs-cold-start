...
for simulating the time required for a PEMFCs to warm up from -20℃ to 30℃ during cold-start.
...
if __name__ == "__main__":
    ...
    # 保存模型
    joblib.dump(model, 'readytime_RF_optimized.pkl')
    print(f"优化后的RF模型已保存: readytime_RF_optimized.pkl")
