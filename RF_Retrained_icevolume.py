...
for simulating the maximum ice formation within the cathode CL during the cold start of PEMFCs.
...
if __name__ == "__main__":
    ...
    # 保存模型
    joblib.dump(model, 'icevolume_RF_optimized.pkl')
    print(f"优化后的RF模型已保存: icevolume_RF_optimized.pkl")
