...
Bayesian hyperparameter tuning for simulating the cathode ice volume fraction at cold
start of PEM fuel cells
...
if __name__ == "__main__":
    ...
    # 保存模型
    joblib.dump(best_model, 'icevolume_XGB_optimized.pkl')
    print(f"优化后的XGBoost模型已保存: icevolume_XGB_optimized.pkl")
